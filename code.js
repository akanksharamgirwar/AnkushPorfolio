        // This data would typically be loaded from an API or a local JSON file in a more complex app.
const skills = [
...
const caseStudies = [
  {
    ...
    summary: "Objective: Drive inbound calls through search ads...",
    impact: [
  ...
  },
  {
    ...
    summary: "Objective: Improve conversion efficiency with broad responsive ad testing...",
    impact: [
  ...
  },
  {
    ...
    summary: "Objective: Launch seasonal/assistance-related program with limited budget...",
    impact: [
...
function renderPortfolio() {
    // This is where the JavaScript would iterate through the data arrays (skills, experience, caseStudies)
    // and dynamically create the HTML elements to inject into the page.
    
    // For example, to render the skills:
    // const skillsContainer = document.querySelector('#skills .grid');
    // skills.forEach(skill => {
    //     const skillCard = document.createElement('div');
    //     skillCard.className = 'skill-card'; // Add our CSS class
    //     skillCard.innerHTML = `<p>${skill}</p>`;
    //     skillsContainer.appendChild(skillCard);
    // });
    
    // The same would be done for all other dynamic sections.
}

// Call the function to build the page when the window loads
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans leading-relaxed">
      ...
      <footer className="bg-white border-t border-gray-200 py-6">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-gray-600">
          ©️ {new Date().getFullYear()} Ankush Jha — Digital Marketing Strategist. Built with React & Tailwind.
        </div>
      </footer>
    </div>
  );
